# Guía Rápida de Uso: Sofía (Para Clientes Comerciantes)

Este texto está formateado con la sintaxis nativa de WhatsApp (`*negrita*`, `_cursiva_`, emojis) para ser enviado o reenviado directamente al chat personal del comerciante (ferretería, almacén, despensa, kiosco).
...
A partir de hoy no necesitás abrir 10 planillas ni volverte loco buscando entre los mensajes de los viajantes. Gestionás todas tus compras directamente desde este chat, como si hablaras con una persona.
