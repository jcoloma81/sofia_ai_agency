...
async def receive_whatsapp_webhook(
    ...
    if is_client_or_emp and clean_msg_lower in [
        ...
        commands_block = (
            ...
            "🛡️ *dudas* ➔ Respuestas sobre aumentos, listas viejas o equivocadas de viajantes, privacidad y seguridad comercial.\n"
        ...
        if is_ferret:
            menu_reply = (
                ...
                f"4️⃣ _Reenviame una lista de precios en PDF o Excel (¡si el viajante manda una lista equivocada, tus costos quedan 100% protegidos!)_ 🛡️\n"
                f"5️⃣ _«¿Qué proveedores tengo registrados?»_\n"
                f"6️⃣ _«Sofi, agendá a Carlos de Distribuidora El Progreso al 343...» (o «Carlos cambió de número al 343...»)_ 🆕\n"
